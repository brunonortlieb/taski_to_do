...
void main() {
  ...
  group('DonePage', () {
    testWidgets('should display an empty state when doneTasks is empty',
    ...
    testWidgets(
        'should display tasks and delete button when doneTasks is not empty',
        (WidgetTester tester) async {
    ...
    testWidgets('should call onDeleteAllTasks when delete button is pressed',
        (WidgetTester tester) async {
      when(() => mockStore.doneTasks).thenReturn([kTaskEntity]);
      when(() => mockStore.onDeleteAllTasks(any()))
